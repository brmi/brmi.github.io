    ...
    <div className="aboutBox">
      ...
      <div className="aboutpic">
        ...
        <ul className="social-accounts">
            ...
            <li className="li-instagram">
              <a href="https://www.instagram.com/strawberrygorl/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="aboutwriteup">
      	<div className="description">
			...
			join a team that lies at the intersection of design and engineering.</p>   

			<p>Currently I am focusing on mastering the web development skills that will allow me to bring 
			designs to life with 100% pixel perfection! In the future I would like to explore VR and AR design and development. </p> 
			...
			<p>Other than that I like to doodle, play video games, read comics, travel, and eat!</p> 
		</div>
        ...
        <li>
          ...
          <h5 className="dates"><span className="boldItalicRed"> >> </span>Graduate December 2018 </h5>
				...
				<li>
					...
					<h5 className="dates"><span className="boldItalicRed"> >> </span> Winter 2015 - now </h5>
				</li>
			</ul>
		</div>
      </div>
